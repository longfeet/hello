...
<head>
    ...
    <!-- Morris Chart Styles-->
    <link href="/assets/adminTemplate/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
    <!-- Custom Styles-->
    ...
    <!-- JS Scripts-->
    <!-- jQuery Js -->
    <script src="/assets/adminTemplate/js/jquery-1.10.2.js"></script>
    <!-- Bootstrap Js -->
    <script src="/assets/adminTemplate/js/bootstrap.min.js"></script>
    <!-- Metis Menu Js -->
    <script src="/assets/adminTemplate/js/jquery.metisMenu.js"></script>
    <!-- dataTables js -->
    <script src="/assets/adminTemplate/js/dataTables/jquery.dataTables.js"></script>
    <script src="/assets/adminTemplate/js/dataTables/dataTables.bootstrap.js"></script>
    <!-- Morris Chart Js -->
    <script src="/assets/adminTemplate/js/morris/raphael-2.1.0.min.js"></script>
    <script src="/assets/adminTemplate/js/morris/morris.js"></script>
    <!-- Custom Js -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>-->
                            ...
                            <li class="divider"></li>
                            <li><div style="padding: 3px 20px;">当前用户：<?=$this->params['staffName'] ?></div></li>
