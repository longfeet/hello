        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    维修列表
                    <a href="javascript:;" class="btn btn-info" id="exportExcel" style="float:right;margin-top:-0.5rem;margin-right:1rem;">维修信息导出</a>
                </div>
                <div class="panel-heading">
...
$(window).ready(function(){
    ...
    $("#exportExcel").click(function(){
        window.location.href = "/admin/adv/exportexcel?value=adv_install_status&thisVal=1";
    });
