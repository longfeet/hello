<div id="page-inner">
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">广告管理/ <small>广告位下刊管理</small></h1>
        </div>
    </div>
    <!-- /. ROW  -->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    下刊列表
                    <a href="javascript:;" class="btn btn-info" id="exportExcel" style="float:right;margin-top:-0.5rem;margin-right:1rem;">下刊信息导出</a>
                </div>
                <div class="panel-heading">
...
$(window).ready(function(){
    status_search.value = "adv_pic_status";
    status_search.thisVal = 3;    //下刊
    getList();
    $("#fix_status").show();

    $("#exportExcel").click(function(){
        window.location.href = "/admin/adv/exportexcel?value=adv_pic_status&thisVal=3";
    });
