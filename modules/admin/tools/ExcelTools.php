...
//        }
    ...
    public static function advExport($fileName,$data)
    {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('I1', '年空刊率')
            ->setCellValue('J1', '上刊率')
            ->setCellValue('K1', '人员分配');
        ...
        foreach($data as $key=>$value)
        {
            ...
            $objPHPExcel->getActiveSheet(0)->setCellValue('I' . $i, $value['adv_rest_rate']);
            $objPHPExcel->getActiveSheet(0)->setCellValue('J' . $i, $value['adv_rate']);
            $objPHPExcel->getActiveSheet(0)->setCellValue('K' . $i, $value['people_num']);
            $num++;
            $i++;
        }
